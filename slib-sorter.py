...
pattern_lists = {
    ...
    "BassLoops": ['bass_loop', 'bass_loops', 'bass', 'Bass', 'BS', 'bs', 'Bass loops'],
    "BassHits": ['Bass_Hit', 'Bass_Hits', 'bass_hit', 'bass_hits'], 
    "Melodic": ['KEY', 'KEYS', 'Lead', 'Organ', 'organ', 'ORGAN', 'melodic', 'cj_170_melodic_loop', 'Melodic', 'MELODIC', 'Melody','Melody Loop', 'Arp', 'arp', 'melodic_loop', 'Arpeggio', 'arpeggio', 'ARP', 'Melody', 'melody', 'Melody', 'SEQ', 'seq', 'Bells', 'BELLS', 'Bell', 'bell', 'bells', 'Piano', 'piano', 'PIANO', 'Vibraphone', 'vibraphone'],
    ...
    "DrumLoops": ['loops', 'drums', 'DRUMS', 'DRMLP', 'drmlp', 'loop', 'Drums', 'LOOP', 'DnB_Drum_Loop', '_DnB_Drum_Loop_', 'Drum_Loop', 'Drum Loops', 'Drum_Beat', 'drum_beat', 'drum_beats', 'fill', 'rundown', 'break', 'breaks', 'breakbeat', 'BREAK', 'Break', 'fills', 'Fills', 'FILLS', 'FILL', 'Fill', 'top', 'TOP', 'Top', 'Loop', 'Loops'],
