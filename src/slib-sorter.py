...
pattern_lists = {
    ...
    "DrumLoops": ['DnB_Drum_Loop', 'DRMLP','_DnB_Drum_Loop_', 'Drum_Loop', 'Drum Loops', 'Drum_Beat', 'drum_beat', 'drum_beats', 'fill', 'rundown', 'break', 'breaks', 'breakbeat', 'BREAK', 'Break', 'fills', 'Fills', 'FILLS', 'FILL', 'Fill', 'top loop', 'TOP loop', 'Top loop'],
